...
def predict_single(model: LitPIC50, featurizer: MolecularFeaturizer, smiles: str) -> float | None:
...
def predict_batch(
    model: LitPIC50, featurizer: MolecularFeaturizer, smiles_list: list[str]
